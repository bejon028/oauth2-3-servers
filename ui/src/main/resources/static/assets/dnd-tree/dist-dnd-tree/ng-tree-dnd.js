...
function fnInitTreeDnD($timeout, $http, $compile, $parse, $window, $document, $templateCache,
    ...
    function fnController($scope, $element, $attrs) {
        ...
        $scope.$tree_class = 'table table-bordered table-hover mt10';
        ...
        function custom_node(node){
            node.__hashKey__ = node.id;
            return node;
        }
    ...
    [
        ...
        $templateCache.put(
            ...
            ['<table class="table table-bordered table-hover mt10">',
             ...
             '         {{(expandingProperty.displayName | translate) || expandingProperty.field || expandingProperty}}',
             '        <\/th>',
             '        <th ng-repeat="col in colDefinitions" ng-class="col.titleClass" ng-style="col.titleStyle">',
             '         {{(col.field | translate) || col.displayName}}',
             '     </th>',
             '    </tr>',
             '    </thead>',
